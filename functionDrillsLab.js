...
// arrow
// declaration
expression = "I had to set these equal to something so my code would still run"
...
let nameGreeting = nameCheck("Calvin");
...
function maxFrogs(gold){
  return (Math.floor(gold / 3 ))
}
console.log(maxFrogs(20))
...
//I actually did that the first time, so I'm just going to leave this blank and ask you to reference the above code.
